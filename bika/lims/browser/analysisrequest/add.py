...
class AnalysisRequestAddView(AnalysisRequestViewView):
    ...
    def __init__(self, context, request):
        ...
        self.layout = "columns"
        self.ar_count = self.request.get('ar_count', 1)
        try:
    ...
    # I don't see from where this function is called!!
    ...
    def services_widget_content(self, poc, ar_count=None):
        ...
        # TODO: This following line is not really important it's redundant. The constructor of "AnalysisServicesView"
        # TODO: already call folderitems() function. I made this line as comment, but before it wasn't. Hocine says!
        #s.folderitems()
...
class ajaxAnalysisRequestSubmit():
    ...
    def __call__(self):
        ...
        print(new_ars)
        print(self.context.bika_setup.getAutoPrintStickers())
